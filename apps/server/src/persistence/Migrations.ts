...
import Migration0034 from "./Migrations/034_ProjectionThreadPendingBackgroundTasks.ts";
import Migration0035 from "./Migrations/035_ProjectionThreadsSnoozed.ts";
import Migration0036 from "./Migrations/036_ProjectionThreadTasks.ts";
...
export const migrationEntries = [
  ...
  [34, "ProjectionThreadPendingBackgroundTasks", Migration0034],
  [35, "ProjectionThreadsSnoozed", Migration0035],
  [36, "ProjectionThreadTasks", Migration0036],
] as const;
